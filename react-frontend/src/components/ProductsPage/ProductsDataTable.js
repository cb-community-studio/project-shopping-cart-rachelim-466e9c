...
const ProductsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const imageTemplate7 = (rowData, { rowIndex }) => <Image src={rowData.productImage}  alt="Image" height="60px" />
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="productImage" header="Image" body={imageTemplate7} style={{ minWidth: "8rem" }} />
